...
<h1 class="text-center text-primary mt-1">QUẢN LÝ NHÀ CUNG CẤP</h1>
<c:url value="/supplier/add" var="action" />
<c:if test="${errMsg != null}">
    <div class="alert alert-danger">
        ${errMsg}
    </div>
</c:if>
<form:form method="post"  action="${action}" modelAttribute="supplier">
